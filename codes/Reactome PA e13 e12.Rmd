...
```{r}
setwd("C:/Users/trant/Desktop/Embryonic RNA seq/My-repo/data")
e12e13de = read.csv("e13_e12_sig_genes.txt", row.names = 1)
head(e12e13de)
```

subset for genes with abs(log2FC) >= 1

```{r}
subset = subset(e12e13de, abs(log2FoldChange) >= 0.5)
str(subset)
```
```{r}
...
tiff("ReactomePA E13_E12.tiff", units = "in", height = 10, width = 40, res = 500)
