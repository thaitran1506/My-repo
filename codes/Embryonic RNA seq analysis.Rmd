...
```{r}
colnames(embryonic_data) = c("e11.sample1", "e11.sample2", "e11.sample3", "e11.samp5", "e11.sample5", "e12.sample1", "e12.sample2", "e12.sample3", "e12.sample4", "e12.sample5", "e13.sample1", "e13.sample2", "e13.sample3", "e13.sample4", "e13.sample5", "e13.sample6", "e13.sample7", "e13.sample8", "e13.sample9", "e14.sample1", "e14.sample2", "e14.sample3", "e14.sample4", "e14.sample5")
```
...
```{r}
e14_e13_count_table = embryonic_data[, 11:24]
head(e14_e13_count_table)
```
Create meta data for E12 and E13 data
```{r}
stage_E13_E14 = c(rep("E13", 9), rep("E14", 5))
