...
```{r}
cluster_1 = cluster_1[order(cluster_1$Family),]
```
...
```{r}
setwd("~/Documents/GitHub/My-repo/My-repo/Graphs")
png("heatmap of transcription factors relative expression cluster 1.png", width = 1000, height = 5000, units = "px")
...
```{r}
cluster_2 = cluster_2[order(cluster_2$Family),]
```
...
```{r}
setwd("~/Documents/GitHub/My-repo/My-repo/Graphs")
png("heatmap of transcription factors relative expression cluster 2.png", width = 1000, height = 5000, units = "px")
...
```{r}
cluster_3 = cluster_3[order(cluster_3$Family),]
```
...
```{r}
setwd("~/Documents/GitHub/My-repo/My-repo/Graphs")
png("heatmap of transcription factors relative expression cluster 3.png", width = 1000, height = 5000, units = "px")
