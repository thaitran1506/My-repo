...
```{r}
setwd("C:/Users/trant/Desktop/Embryonic RNA seq/My-repo/data")
e11e12de = read.csv("e12_e11_sig_genes.txt", row.names = 1)
head(e11e12de)
```
...
```{r}
subset = subset(e11e12de, abs(log2FoldChange) >= 0.5)
str(subset)
```
```{r}
...
tiff("ReactomePA.tiff", units = "in", height = 10, width = 40, res = 500)
