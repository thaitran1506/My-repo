...
```{r}
e12.e11.de.tf.0.5 = subset(e12.e11.de.tf, abs(e12.e11.de.tf$log2FoldChange) >= 0.5)
```

There are 270 DE TFs that have log2FC either >= 0.5 or <= -0.5. Write this result to file
...
e13.e12.de.tf.0.5 = subset(e13.e12.de.tf, abs(e13.e12.de.tf$log2FoldChange) >= 0.5)
```
...
```{r}
e14.e13.de.tf.0.5 = subset(e14.e13.de.tf, abs(e14.e13.de.tf$log2FoldChange) >= 0.5)
```
...
```{r}
e13.e11.de.tf.0.5 = subset(e13.e11.de.tf, abs(e13.e11.de.tf$log2FoldChange) >= 0.5)
```
...
```{r}
setwd("C:/Users/trant/Desktop/My-repo/My-repo/data")
write.csv(e13.e11.de.tf.0.5, "e13_e11_de_tf_0.5.csv")
```
...
```{r}
e14.e11.de.tf.0.5 = subset(e14.e11.de.tf, abs(e14.e11.de.tf$log2FoldChange) >= 0.5)
```
...
```{r}
setwd("C:/Users/trant/Desktop/My-repo/My-repo/data")
write.csv(e14.e11.de.tf.0.5, "e14_e11_de_tf_0.5.csv")
```
...
```{r}
e14.e12.de.tf.0.5 = subset(e14.e12.de.tf, abs(e14.e12.de.tf$log2FoldChange) >= 0.5)
```
...
```{r}
setwd("C:/Users/trant/Desktop/My-repo/My-repo/data")
write.csv(e14.e12.de.tf.0.5, "e14_e12_de_tf_0.5.csv")
```
